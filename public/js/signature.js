...
$(document).ready(function () {
  ...
  var counter = 0;
  findDeleteButtons(); // set event-handlers
  ...
  function findDeleteButtons() {
    var deleteButtonList = document.querySelectorAll('.artificial_delete');
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
      for (var _iterator = deleteButtonList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var button = _step.value;
        var buttonId = button.id.substring(6);
...
/***/ 1:
/*!*****************************************!*\
  !*** multi ./resources/js/signature.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/airbnb-guestbook/resources/js/signature.js */"./resources/js/signature.js");
